...
SECRET_KEY = 'django-insecure-#ow&8kqu4x8=*3k))uj(yomm2!o(_t)&1szd+iurn8rivn%xew'
...
# ALLAUTHSETTINGS
LOGIN_REDIRECT_URL = '/'
ACCOUNT_EMAIL_REQUIRED = True    # Recommanded
# ACCOUNT_CHANGE_EMAIL = False
# ACCOUNT_MAX_EMAIL_ADDRESSES = 6
ACCCOUNT_EMAIL_CONFIRMATION_EXPIRE_DAYS = 1
